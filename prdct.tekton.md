...
title: Tekton
desc: 'it would be nice to have something that had a very small footprint, that could be decentralized to each team while strongly encouraging all pipelines to look similar.'
